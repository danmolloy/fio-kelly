...
export default function ContactSection() {
  ...
  const sendFail = (
    ...
    >
      ...
      <p id="dialog-desc" className="text-sm">
        Please{" "}
        <a href="mailto:fiokelly@gmail.com" className="text-blue-500">
          send an email
        </a>
        .
      </p>
  ...
  return (
    <IndexSection
      title="Contact"
      classNames="bg-gradient-to-b from-zinc-100 to-zinc-100 via-zinc-50"
    >
      <div
        data-testid="contact-form"
        className="flex flex-row w-full justify-between  h-[30rem]"
      >
        <Formik
          initialValues={{
            name: "",
          ...
          {(props) => (
            <Form className="font-sans flex flex-col lg:w-1/2  ">
              <div className=" mb-2 ">
                <p className="my-1">
                  ...
                  <a
                    target="_blank"
                    href={
                      "https://maslink.co.uk/client-directory?client=KELLF1&instrument=FLUTE1"
                    }
                ...
                <p className="my-1">
                  For all other enquiries, complete the form below.
                </p>
              </div>
              <div className="flex flex-col my-1">
                ...
                <div className="h-6">
                  <ErrorMessage name="name">
                    {(msg) => (
                      <div className="text-sm text-red-500 h-6">{msg}</div>
                    )}
                  </ErrorMessage>
                </div>
              </div>
              ...
              <button
                ...
                id="submit-button"
                type="submit"
                className="disabled:opacity-40 disabled:hover:cursor-default hover:bg-blue-50 border shadow-sm border-blue-500 text-blue-500 m-2 p-1 w-24 rounded self-end"
              >
                Submit
              </button>
              <div>
