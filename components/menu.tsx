...
export default function Menu(props: MenuProps) {
  ...
  return (
    <div className={`${showMenu ? "opacity-90" : "opacity-0" } ease-out transition duration-300 rounded-bl flex flex-col z-20 bg-white fixed w-screen  min-h-screen  right-0 shadow text-2xl`}>
